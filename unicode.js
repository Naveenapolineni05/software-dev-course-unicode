...
// Task 1
let word = "Code";
let firstCodePoint = word.charCodeAt(0);
let thirdCodePoint = word.charCodeAt(2);
...
// Task 3
let original = "Launch";
// Get first and last characters using Unicode
let firstChar = original.charAt(0);                    
let lastChar = original.charAt(original.length - 1);  
